 ...
 */
export declare function isFragment(node: Trait | TypeDeclaration | ResourceType | DocumentationItem): boolean;
/**
 * Convert fragment representing node to FragmentDeclaration instance.
 */
export declare function asFragment(node: Trait | TypeDeclaration | ResourceType | DocumentationItem): FragmentDeclaration;
