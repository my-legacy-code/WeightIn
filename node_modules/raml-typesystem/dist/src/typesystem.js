...
var RestrictionsConflict = (function (_super) {
    ...
    function RestrictionsConflict(_conflicting, _stack, source) {
        _super.call(this, Status.ERROR, 0, "Restrictions conflict " + _conflicting + " and " + (_stack != null ? _stack.getRestriction().toString() : ""), source);
...
exports.NULL = exports.ANY.inherit("null");
...
exports.NULL.addMeta(new NullRestriction());
